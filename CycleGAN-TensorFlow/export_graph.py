...
tf.flags.DEFINE_integer('image_height', '240', 'image size, default: 240')
tf.flags.DEFINE_integer('image_width', '320', 'image size, default: 320')
...
def export_graph(model_name, XtoY=True):
  ...
  with graph.as_default():
    cycle_gan = CycleGAN(ngf=FLAGS.ngf, norm=FLAGS.norm, image_height=FLAGS.image_height, image_width=FLAGS.image_width)
